...
const TestimonialData = [
  ...
  },
  {
    ...
    text: "I am thoroughly impressed with the customer service and the quality of the clothes. They have a customer for life in me.",
...
const Testimonials = () => {
  ...
  return (
    <div id="review" className="py-10 mb-10">
